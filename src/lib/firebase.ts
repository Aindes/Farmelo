...
// Silencing the scary red overlay in Next.js Dev Mode for Firestore connectivity issues
// This happens when internet is slow/unreachable and Firebase logs an internal error
if (typeof window !== "undefined") {
  ...
  console.error = (...args) => {
    ...
    if (errorString.includes("Could not reach Cloud Firestore backend")) {
      console.warn("FARMELO: Firestore is in offline mode (Waiting for connection...)");
      return;
    }
